%% LaTeX Template for cat-serve 2025
%%
...
% ------------------------------------------------------------
\begin{document}
\title{CAT-serve 2025 Paper Template} 
...
\begin{abstract}
   Instructions are given for the preparation and submission of papers for the 2025 \emph{Content-Aware Caching and Scheduling for Transformer Model Serving} workshop.
\end{abstract}

\section{Submission of Papers for Review}

Papers in the form of a PDF file, formatted as described below, may be
submitted online as indicated on the webpage. 

The deadline for registering the article and uploading the manuscript is \textbf{February 2, 2025} (AoE). 

The primary content of a paper is restricted in length to \textbf{ 3 pages, excluding references}. 
 
The style should be used as presented here. Submissions should use a font size of at least 10 points and have reasonable margins on all 4 sides of the text.


\section{Submission Guidelines}
\begin{itemize}
\item Submissions should state the research problem, motivation, and technical contribution. All submissions must be in English. The submissions should be sent in a single PDF file
\item Papers can present work in progress, exploratory/preliminary research or already published work
\item Submissions will be assessed based on their novelty, technical quality, potential impact, interest, clarity, relevance, and reproducibility
\item Reviews will not be blind, so please submit without anonymizing authors in the submitted PDF
\item There will be no formal proceedings, allowing authors the flexibility to extend and publish their work in other conferences and journals
\item For each accepted paper, at least one author must attend the workshop and present the paper
\end{itemize}
...
The paper with a double column format, not exceeding 3 pages, can be formatted as shown in this sample file \LaTeX{}
...
instructions on how to format your paper. For example, example codes for
different numbers of authors, figures and tables, and references
can be found (they are commented on).
...
arrays with broken equations, see \cite{typesetmoser}.


\subsection{PDF Requirements}

Only electronic submissions in the form of a PDF file will be
...
balanced. Instructions for that purpose are given in the source file (commented out).

Moreover, example code for an appendix (or appendices) can also be
found in the source file (commented out).
...
We are indebted to Michael Shell for maintaining and improving the site.
\texttt{IEEEtran.cls}. 
